...
erhu =  \relative d'' {
    ...
    e2 _\mp a2 | % 31
    d,2 a'16 [ b16 a16 fis16 ]
    d4 | % 32
    fis4 ais8 [ b8 ] cis2 | % 33
    b8 [ fis8 d'8 cis8 ] b2 | % 34
    b4. a8 gis2 | % 35
    e2 r4 fis8 [ _\f a8 ] | % 36
    b2. fis8 [ a8 ] | % 37
    e2. fis8 [ a8 ] | % 38
    b8 d4 b8 a4 d,8 [
    fis8 ] | % 39
    ...
    b8 [ fis8 d'8 cis8 ] b2 | % 74
    b4. a8 gis2 | % 75
    e2 r2 | % 76
    fis4. _\mp g8 fis4. d8 | % 77
    e4. fis8 e4. cis8 | % 78
    d4. e8 fis4. d8 | % 79
    cis4. d8 cis4 a4 |
    \barNumberCheck #80
